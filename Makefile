#   Copyright
#
#	Copyright (C) 2009-2013 Jason aka jamilsoft <myakububauchi@gmail.com>
#     
#
#
#
...
DISTFILES   = jamilcrack.c jamilcrack.1 charset.lst
BINDIR	    = $(PREFIX)/bin
...
val:	jamilcrack.c
	...
	@echo "valgrind --leak-check=yes jamilcrack ..."
	@echo ""

jamilcrack: jamilcrack.c
